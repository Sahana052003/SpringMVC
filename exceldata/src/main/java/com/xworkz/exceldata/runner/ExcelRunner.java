...
public class ExcelRunner {
    public static void main(String[] args) {
     ...
     try ( InputStream fis = new FileInputStream("C:\\Users\\admin\\Documents\\student.xlsx");
         ...
         for (int i = 1; i <= sheet.getLastRowNum() && i <= 10; i++) {
             ...
             ExcelEntity entity = new ExcelEntity();
              ...
              entity.setPhone_No( Long.parseLong(formatter.formatCellValue(row.getCell(2))));
              entity.setFees_due(  Double.parseDouble(formatter.formatCellValue(row.getCell(3)))  );
